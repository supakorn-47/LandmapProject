...
export const ADM04GetDataList = async () => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            await axios.get(URL_API('backOfficeApi/LPASM04/Get'), authorization)
                .then(res => {
                    resolve(res.data);
                });
        }
...
export const ADM04CreateData = async (body) => {
    return new Promise(async (resolve, reject) => {
        try {
            let authorization = await config_headers();
            await axios.post(URL_API('backOfficeApi/LPASM04/Add'), {
...
export const ADM04UpdateData = async (body) => {
    return new Promise(async (resolve, reject) => {
        try {
            let authorization = await config_headers();
            await axios.put(URL_API('backOfficeApi/LPASM04/Update'), {
...
export const ADM04CancelData = async (body) => {
    return new Promise(async (resolve, reject) => {
        try {
            let authorization = await config_headers();
            await axios.delete(URL_API('backOfficeApi/LPASM04/Delete'), {
                data: {
...
export const UpdateOrder = async (body) => {
    ...
    return new Promise(async (resolve, reject) => {
        try {
            let authorization = await config_headers();
            await axios.put(URL_API('backOfficeApi/LPASM04/UpdateOrder'), {
                "order_seq_list": arr
            }, authorization)
                .then(res => {
                    resolve(res.data);
